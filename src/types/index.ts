export { default as ArrayPath } from 'src/types/ArrayPath';
...
export { default as Matrix } from 'src/types/IMatrix';
export { default as Point } from 'src/types/IPoint';
